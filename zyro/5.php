...
<head>
	...
	<link href="css/5.css?ts=1517778470" rel="stylesheet" type="text/css" /> {{ga_code}}
	...
	<div class="root">
		<div class="vbox wb_container" id="wb_header">
			...
			<div class="wb_cont_inner">
				<div id="wb_element_instance70" class="wb_element wb-menu">
					<ul class="hmenu">
						<li>
			...
			<div class="wb_cont_inner">
				<div id="wb_element_instance74" class="wb_element" style=" line-height: normal;">
					<h5 class="wb-stl-subtitle" style="text-align: center;">
						<span class="wb_tr_ok">YouTuber/Streamer Application</span>
					</h5>
				...
				<div id="wb_element_instance77" class="wb_element" style="width: 100%;">
					<?php
