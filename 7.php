...
<head>
	...
	<!-- Facebook Open Graph -->
	<meta name="og:title" content="Moderator Application" />
	...
	<link href="css/7.css?ts=1517778470" rel="stylesheet" type="text/css" /> {{ga_code}}
	...
	<div class="root">
		<div class="vbox wb_container" id="wb_header">
			...
			<div class="wb_cont_inner">
				<div id="wb_element_instance43" class="wb_element wb-menu">
					<ul class="hmenu">
						<li>
				...
				<div id="wb_element_instance44" class="wb_element wb_element_picture">
					<a href="Home/">
						<img alt="gallery/mlg_scattervolt" src="gallery/photo-ts1517260810.jpg">
					</a>
				</div>
				<div id="wb_element_instance45" class="wb_element" style=" line-height: normal;">
		...
		<div class="vbox wb_container" id="wb_main">
			...
			<div class="wb_cont_inner">
				<div id="wb_element_instance47" class="wb_element" style=" line-height: normal;">
					<h5 class="wb-stl-subtitle" style="text-align: center;">
						<span class="wb_tr_ok">Moderator Application</span>
					</h5>
				...
				<div id="wb_element_instance48" class="wb_element" style=" line-height: normal;">
					<h3 class="wb-stl-heading3" style="text-align: center;">
						<span style="color:rgba(247,247,247,1);">This is the Moderator Application: Mention Admins in Discord if you need any help.</span>
					</h3>
				</div>
			...
			<div class="wb_cont_outer">
				<div id="wb_element_instance49" class="wb_element" style=" overflow: hidden;">
					<iframe src="https://docs.google.com/forms/d/e/1FAIpQLScXn75flVmU7AVBNy1PHaeVmtkO-WEp2wUhPAoBNEsJ4UFIJQ/viewform?embedded=true"
		...
		<div class="vbox wb_container" id="wb_footer">
			...
			<div class="wb_cont_inner" style="height: 124px;">
				...
				<div id="wb_element_instance51" class="wb_element" style="text-align: center; width: 100%;">
